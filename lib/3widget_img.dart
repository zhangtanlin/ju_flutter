...
class MyCustomizeIcon {
  ...
  // 退出
  static const IconData exit = const IconData(
    0xe90d,
    fontFamily: 'CustomizeIcon',
    matchTextDirection: true,
  );
  // 倒三角
  static const IconData triangleDown = const IconData(
    0xe90c,
    fontFamily: 'CustomizeIcon',
    matchTextDirection: true,
  );
  ...
  // 正三角
  static const IconData triangleTop = const IconData(
    0xe90b,
    fontFamily: 'CustomizeIcon',
    matchTextDirection: true,
  );
  ...
  // 减
  static const IconData less = const IconData(
    0xe904,
    fontFamily: 'CustomizeIcon',
    matchTextDirection: true,
  );
